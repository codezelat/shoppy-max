                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('direct-reseller-dues.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Direct User Due Payments</a>
                        </div>
                    </li>
    ...
    <div class="space-y-6 m-6">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <form method="GET" action="{{ route('direct-reseller-dues.show', $reseller->id) }}" class="flex flex-col gap-2">
