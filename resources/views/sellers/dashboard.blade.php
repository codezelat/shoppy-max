        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 text-gray-900">
                    <form method="GET" action="{{ route('sellers.dashboard') }}" class="flex flex-wrap gap-4 items-end">
                        <div>
                            <label for="seller_id" class="block text-sm font-medium text-gray-700">Select Seller</label>
                            <select id="seller_id" name="seller_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
