                        ...
                        <div class="grid grid-cols-1 gap-6 xl:grid-cols-12">
                            <div class="xl:col-span-7 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                                ...
                                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    ...
                                    <div>
                                        <label class="block mb-1.5 text-sm font-medium text-gray-900 dark:text-white">Courier <span class="text-red-500">*</span></label>
                                        <select x-model="form.courier_id" @change="onCourierChange()" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                                            <option value="">Select Courier</option>
                                            @foreach($couriers as $courier)
                                                <option value="{{ $courier->id }}">{{ $courier->name }}</option>
                                            @endforeach
                                        </select>
                                        <p x-show="!form.courier_id" class="mt-1 text-xs text-red-500">Select a courier to continue.</p>
                                    </div>
                                    <div>
                                        <label class="block mb-1.5 text-sm font-medium text-gray-900 dark:text-white">Delivery Charge <span class="text-red-500">*</span></label>
                                        <select x-model="form.courier_charge" :disabled="!form.courier_id || selectedCourierRates.length === 0" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 disabled:bg-gray-100 disabled:text-gray-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:disabled:bg-gray-800 dark:disabled:text-gray-400">
