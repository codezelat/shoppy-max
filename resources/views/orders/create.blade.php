<x-app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('orders.store') }}" method="POST">
                        @csrf
                        <input type="hidden" name="order_type" value="general">
    ...
    <script>
        function orderForm() {
            // Simplified logic as we don't have full product data in JS from controller efficiently without json_encode
            // We'll rely on the data-price attribute in the select options
            return {
