                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Categories</span>
                        </div>
                    </li>
                </ol>
            </nav>
    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-gray-800">
        ...
        <div class="flex flex-col space-y-4 lg:flex-row lg:items-start lg:justify-between lg:space-y-0 lg:space-x-4 mb-6">
                ...
                <form method="GET" action="{{ route('categories.index') }}">
                    <div class="grid grid-cols-1 md:grid-cols-12 gap-3">
                        ...
                        <div class="md:col-span-4 flex items-center gap-2">
                            ...
                            @if(request('search'))
                                <a href="{{ route('categories.index') }}" class="w-full md:w-auto text-center p-2.5 text-sm font-medium text-gray-900 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Clear</a>
                            @endif
                        </div>
                    </div>
                </form>
            ...
            <div class="flex flex-wrap items-center gap-2 lg:flex-nowrap lg:justify-end">
                <a href="{{ route('categories.create') }}" class="whitespace-nowrap flex items-center justify-center px-4 py-2 text-sm font-medium text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                ...
                <tbody>
                    @forelse($categories as $category)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                            <td class="px-6 py-4">
                                <span class="bg-gray-100 text-gray-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-500 font-mono">
                                    {{ $category->code }}
                                </span>
                            </td>
