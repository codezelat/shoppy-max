                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">User Due Payments</span>
                        </div>
                    </li>
                </ol>
            </nav>
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0 md:space-x-4 mb-6">
            ...
            <div class="flex-1 w-full md:max-w-xl">
             ...
             <div class="flex items-center space-x-2">
                ...
                <a href="{{ route('reseller-dues.index', ['sort' => 'name', 'direction' => 'asc']) }}" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-400">Name</a>
                <span class="text-gray-300 dark:text-gray-600">|</span>
                <a href="{{ route('reseller-dues.index', ['sort' => 'due_amount', 'direction' => 'desc']) }}" class="text-sm font-medium text-blue-600 hover:underline dark:text-blue-400">Highest Due</a>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center">
                            <a href="{{ route('reseller-dues.show', $reseller->id) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                View Statement
