                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Direct Reseller Targets</span>
                        </div>
                    </li>
                </ol>
            </nav>
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex items-center justify-center space-x-2">
                                ...
                                <form action="{{ route('reseller-targets.destroy', $target) }}" method="POST" class="inline" data-confirm-message="Are you sure you want to delete this target?">
                                    @csrf
                                    @method('DELETE')
