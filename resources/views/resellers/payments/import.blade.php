    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-gray-800">
        ...
        <div class="max-w-xl mx-auto">
            ...
            <div class="flex justify-center mb-8">
                <a href="{{ route('reseller-payments.import.template') }}" class="flex items-center px-4 py-2 text-sm font-medium text-blue-700 bg-blue-100 rounded-lg hover:bg-blue-200 focus:ring-4 focus:ring-blue-300 dark:bg-blue-900 dark:text-blue-300 dark:hover:bg-blue-800">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"></path></svg>
                    Download Template (Excel)
                </a>
            </div>

            <form action="{{ route('reseller-payments.import.preview') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                <div>
