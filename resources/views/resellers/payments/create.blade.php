                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="{{ route('reseller-payments.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Direct User Payments</a>
                        </div>
                    </li>
                ...
                <div class="space-y-6">
                    <x-form-section title="Balance Summary">
                        ...
                        <p class="text-xs text-gray-500 dark:text-gray-400 mt-2">
                             The direct reseller's due amount will be automatically updated upon saving.
                        </p>
                    </x-form-section>
