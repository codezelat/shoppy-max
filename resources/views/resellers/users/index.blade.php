            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-xl border border-gray-200 dark:border-gray-700">
                <div class="p-6">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                        <a href="{{ route('resellers.users.create') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 shadow-md transition-transform hover:scale-105 flex items-center">
                         ...
                         <div class="flex flex-col md:flex-row gap-3 w-full md:w-auto">
                             ...
                             <!-- Search Form -->
                             <form method="GET" action="{{ route('resellers.users.index') }}" class="flex w-full md:w-auto">
