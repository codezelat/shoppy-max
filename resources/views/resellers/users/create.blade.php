                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('resellers.users.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="user_type" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                        ...
                        <div class="flex items-center justify-between mt-6">
                            ...
                            <a href="{{ route('resellers.users.index') }}" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                                Cancel
                            </a>
                        </div>
                    </form>
