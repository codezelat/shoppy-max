            ...
            <form action="{{ route('customers.store') }}" method="POST"
                ...
                <div class="mb-6">
                    ...
                    <div x-show="country === 'Sri Lanka'" x-transition class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                        ...
                        <!-- District (Already updated above) -->
                        <div>
            ...
            return {
                ...
                handleCountryChange() {
                    if (this.country !== 'Sri Lanka') {
                        ...
                        // Reset when switching back to SL? Or keep?
                        // Generally reset to force clean slate unless we want to remember.
                        // For create, reset is safer.
                         this.province = ''; 
                         this.availableDistricts = [];
                         this.isDynamic = true;
                    }
