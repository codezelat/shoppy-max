    ...
    <div class="max-w-2xl mx-auto space-y-6">
        <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-lg dark:bg-gray-800 dark:border-gray-700">
            <div class="flex items-center mb-4 border-b border-gray-200 dark:border-gray-700 pb-2">
                ...
                <h3 class="text-xl font-bold text-gray-900 dark:text-white">Edit City Details</h3>
            </div>
            ...
            <form action="{{ route('cities.update', $city) }}" method="POST"
                  x-data="{
                      ...
                      provinces: [],
                      districts: [],
                      selectedProvince: '{{ old('province', $city->province) }}',
                      selectedDistrict: '{{ old('district', $city->district) }}',
                      ...
                      updateDistricts() {
                          ...
                          // Only reset district if it's not in the new list (and we're not initializing)
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <select id="province" name="province" x-model="selectedProvince" @change="updateDistricts(); selectedDistrict=''" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="city_name" id="city_name" value="{{ old('city_name', $city->city_name) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="e.g. Colombo" required>
