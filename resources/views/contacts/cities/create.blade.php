        ...
        <div class="p-6 text-gray-900">
            <form action="{{ route('cities.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="city_name" id="city_name" value="{{ old('city_name') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="district" id="district" value="{{ old('district') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
