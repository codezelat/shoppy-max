<x-app-layout>
    @php
        $initialProvince = old('province', $supplier->province);
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $supplier->name) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="business_name" id="business_name" value="{{ old('business_name', $supplier->business_name) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-4 mb-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="mobile" id="mobile" value="{{ old('mobile', $supplier->mobile) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="landline" id="landline" value="{{ old('landline', $supplier->landline) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                         ...
                         <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $supplier->email) }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            <template x-if="!isDynamic">
                                <select name="district" id="district" x-model="district" @change="handleDistrictChange" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    ...
                                    @foreach($initialDistricts as $dist)
                                        <option value="{{ $dist }}" {{ old('district', $supplier->district) == $dist ? 'selected' : '' }}>{{ $dist }}</option>
                                    @endforeach
                                </select>
                            </template>
    ...
    <script>
        function supplierForm() {
            return {
                country: '{{ old('country', $supplier->country ?? 'Sri Lanka') }}',
                province: '{{ $initialProvince }}',
                district: '{{ old('district', $supplier->district) }}',
