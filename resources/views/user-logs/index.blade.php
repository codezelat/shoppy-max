<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700 p-8 md:p-12">
                <div class="max-w-xl">
                    <div class="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-blue-100 text-blue-600 dark:bg-blue-900/40 dark:text-blue-400">
                    ...
                    <h3 class="mt-4 text-2xl font-bold text-gray-900 dark:text-white">Coming Soon</h3>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">
                        User Logs is under development. You will be able to view activity history here soon.
                    </p>
                </div>
            </div>
        </div>
